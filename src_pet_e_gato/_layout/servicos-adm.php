                                ...
                                <table class="table mb-0  table-hover table-bordered table-sm" table="center" id="tabela">
                                    ...
                                    <?php
                                        ...
                                        for ($i = 0; $i < $linhas; $i++){
                                            ...
                                            <td><a class='btn btn-sm btn-danger' data-toggle='modal' data-target='#modalexcluir$servicos[cod_servico]'>
                                            ...
                                            <!-- Modal -->
                                            <div class='modal fade' id='modalexcluir$servicos[cod_servico]' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                                                <div class='modal-dialog' role='document'>
                                                  <div class='modal-content modalcolor'>
                                                    ...
                                                    <div class='modal-footer'>
                                                      ...
                                                      <a href='excluir_servico.php?cod_servico=$servicos[cod_servico]' type='button' class='btn btn-danger'>Excluir</a>
                                                    </div>
                                                  </div>
                                                </div>
                                            </div>";
