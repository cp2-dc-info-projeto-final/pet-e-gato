...
<html lang="pt-br">
  <head>
    <title>Calendário | ADM | Pet&Gatô</title>
    <meta charset="utf-8">
                                    ...
                                    <?php
                                        ...
                                        for ($i = 0; $i < $linhas; $i++){
                                            ...
                                            if(isset($agendamento['cod_cliente'])){
                                                echo"<td>".utf8_encode($agendamento['nome_cliente'])."</td>";
                                            }
                                            else{
                                                echo "<td>***</td>";
                                            }
                                            ...
                                            echo"
                                            <td><a class='btn btn-sm btn-danger'  href='cancela_agendamento-adm.php?cod_agendamento=$agendamento[cod_agendamento]'>
                                            <img src='_img/cancela.svg' width='18'</a>
                                            </td>
                                            <td><a class='btn btn-sm btn-danger'  href='excluir_agendamento.php?cod_agendamento=$agendamento[cod_agendamento]'>
                ...
                <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <input type="button" class="btn btn-primary" data-dismiss="modal" value="Voltar"></input>
                          <a  type="submit" value="Cancelar agendamento" name="Cancela agendamento" type="button" class="btn btn-danger">Excluir agendamento</a>
                        </div>
                      </div>
                    </div>
                </div>
