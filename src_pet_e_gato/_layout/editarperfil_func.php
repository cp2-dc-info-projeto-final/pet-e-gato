...
{  
    ...
    if(empty($senha)){
        ...
        $sql = "UPDATE funcionario SET senha='$senha_cript' WHERE email='$email'";
        ...
        $mensagem = utf8_decode("<h2><u>Olá!</u></h2> <br> <small>Funcionário Pet&Gatô</small> <br> <h3>Sua senha foi alterada com sucesso.</h3>");
