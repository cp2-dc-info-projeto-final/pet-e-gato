...
<html lang="pt-br">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink0000000000000000-to-fit=no">
  ...
  <section class="ftco-section">
        ...
        <h3 class="text-center mb-4">Cadastre-se</h3>
          ...
          <div class="form-group d-md-flex">
	            	<div class="w-50">
	            		<label class="checkbox-wrap checkbox-primary">Administrador
