...
include "conecta_mysql.php";
    ...
    include "envia_email.php";
        ...
        $mensagem = utf8_decode("A Pet&Gatô detectou uma alteração na sua senha. Caso não tenha sido você, <a href='http://localhost/src_pet_e_gato/_layout/recuperar-senha.php'>clique aqui</a> para redefinir sua senha.");
