...
utf8_decode($nome_funcionario = $var["funcionario"]);
utf8_decode($nome_cliente = $var["nome_cliente"]);
utf8_decode($servico = $var["servico"]);
$dia = $var["dia"];
$hora = $var["hora"];
...
include "envia_email.php";
    ...
    $mensagem = utf8_decode("<h2><u>Olá $nome_cliente!</u></h2> <br> <small>Cliente Pet&Gatô</small> <br> <h3>O serviço de <b>$servico</b> no dia <b>$dia</b> às <b>$hora</b> com o funcionário <b>$nome_funcionario</b> precisou ser cancelado. Entre em nosso site e agende um novo horário.</h3> <br> <b><small>A Pet&Gatô agradece a sua compreensão.</small></b>");
    envia_email($para, $assunto, $mensagem);

    $para = $email_funcionario;
    $assunto = utf8_decode("Agendamento cancelado! | Pet&Gatô");
    $mensagem = utf8_decode("<h2><u>Olá $nome_funcionario!</u></h2> <br> <small>Funcionário Pet&Gatô</small> <br> <h3>O serviço de <b>$servico</b> no dia <b>$dia</b> às <b>$hora</b> precisou ser cancelado.</h3>");
    envia_email($para, $assunto, $mensagem);
