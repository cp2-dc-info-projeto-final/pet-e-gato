                                ...
                                <table class="table mb-0  table-hover table-bordered table-sm" id="tabela" table="center">
                                    ...
                                    <?php
                                        ...
                                        for ($i = 0; $i < $linhas; $i++){
                                            ...
                                            <td><a class='btn btn-sm btn-danger' href='excluir_adm.php?matricula=$administrador[matricula]'>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a type="submit" value="Excluir adm" name="Excluir adm" type="button" class="btn btn-danger">Excluir</a>
                        </div>
                      </div>
                    </div>
                </div>
