                                ...
                                <table class="table mb-0  table-hover table-bordered table-sm" id="tabela" table="center">
                                    ...
                                    <?php
                                        ...
                                        for ($i = 0; $i < $linhas; $i++){
                                            ...
                                            <td><a class='btn btn-sm btn-danger' data-toggle='modal' data-target='#modalexcluir$funcionario[matricula]'>
                                            ...
                                            <!-- Modal -->
                                            <div class='modal fade' id='modalexcluir$funcionario[matricula]' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                                                <div class='modal-dialog' role='document'>
                                                  <div class='modal-content modalcolor'>
                                                    ...
                                                    <div class='modal-footer'>
                                                      ...
                                                      <a href='excluir_funcionario.php?matricula=$funcionario[matricula]' type='button' class='btn btn-danger'>Excluir</a>
                                                    </div>
                                                  </div>
                                                </div>
                                            </div>";
