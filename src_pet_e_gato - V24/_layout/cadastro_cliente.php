          ...
          <fieldset>
            ...
            <div class="form-group">
                <label for="nome">Digite seu nome:</label>
		      			<input type="text" name="nome" class="form-control rounded-left" placeholder="Digite seu nome completo" required title="O nome precisa ter pelo menos 10 caracteres">
		      		</div>
