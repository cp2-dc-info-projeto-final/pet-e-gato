...
<html lang="pt-br">
  <head>
  	<title>Login como funcionário | Pet&Gatô</title>
    <meta charset="utf-8">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Login como funcionário</h2>
				</div>
			</div>
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">Entre com suas credenciais</h3>
						<form action="recebelogin-funcionario.php" method="POST" class="login-form">
	            ...
	            <div class="form-group d-md-flex">
	            	<div class="w-50">
	            		<label class="checkbox-wrap checkbox-primary">Lembrar-me
								...
								<a class="links" href="cadastro_funcionario.php">Não possuo um cadastro</a>
